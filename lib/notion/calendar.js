...
import { calendarSnapshot } from "@/lib/content/notion-snapshot";
...
export async function getCalendarRange(start, end) {
  if (!notionConfigured("calendar")) {
    return { configured: false, source: "snapshot", slots: normalizeCalendarSlots(calendarSnapshot, start, end) };
  }
