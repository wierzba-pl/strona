...
const SITE_NAV = `<a href="/oferta">Oferta</a><a href="/portfolio">Portfolio</a><a href="/blog">Blog</a><a href="/kalendarz">Kalendarz</a><a href="/qa">Q&amp;A</a><a href="/produkty">Produkty</a><a href="/free-ukraine">Free Ukraine</a><a href="/kontakt">Kontakt</a><a href="/regulamin">Regulamin</a>`;
...
`;
  ...
  const emptyText = cases.length
    ...
    : configured
    ? "Brak opublikowanych projekt&oacute;w."
    : "Brak opublikowanych projekt&oacute;w.";
...
.wrap{max-width:1080px;margin:0 auto;padding:0 24px 100px}.calendar{background:#fff;border:1px solid #E3DCC9;border-radius:3px;overflow:hidden}.week,.head{display:grid;grid-template-columns:repeat(7,1fr)}.head div{padding:12px 8px;text-align:center;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:.03em;color:#544F45;background:#FAF7F1;border-bottom:1px solid #E3DCC9;border-right:1px solid #E3DCC9}.day{min-height:150px;padding:10px;border-bottom:1px solid #E3DCC9;border-right:1px solid #E3DCC9;background:#fff;display:flex;flex-direction:column;gap:8px}.day.out{opacity:.35}.num{font-size:13px;font-weight:600}.slot{display:flex;justify-content:space-between;gap:8px;border:1px solid #E3DCC9;border-radius:3px;padding:5px 6px;font-size:10.5px;background:#FAF7F1}.slot.free{background:#E8F2FF;border-color:#2F6FAE;color:#245C91}.slot.reserved{background:#FCE8E6;border-color:#D4291B;color:#B51F14}.slot.closed{background:#F1EEE7;border-color:#A79E8C;color:#756F61}.calendar-error{padding:28px;color:#B51F14;font-size:13px}
@media(max-width:760px){.week,.head{grid-template-columns:1fr}.head{display:none}.day{min-height:auto}.nav-in{align-items:flex-start;flex-direction:column}.controls{align-items:stretch}.month-nav{width:100%;display:grid;grid-template-columns:1fr;gap:10px}.small-btn,.jump{width:100%}.month{min-width:0;width:100%;text-align:left}.legend{width:100%;justify-content:flex-start;gap:10px 14px}.wrap{padding-left:16px;padding-right:16px}.hero{padding-left:16px;padding-right:16px}.slot{font-size:12px}}
</style>
</head>
<body>
<nav class="nav"><div class="nav-in"><a class="brand" href="/">EWA WIERZBA</a><div class="links">${SITE_NAV}</div></div></nav>
<header class="hero"><div class="eyebrow">Kalendarz</div><h1>Zarezerwuj<br>sw&oacute;j termin</h1><div class="actions"><a class="btn primary" href="https://www.instagram.com/wierzba.content/" target="_blank" rel="noopener">Napisz do mnie na Instagram</a><a class="btn secondary" href="mailto:hello@ewawierzba.pl">Skontaktuj si&#281; przez Gmail</a></div></header>
